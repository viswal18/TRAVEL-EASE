...
class _ConverterWidgetState extends State<ConverterWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultxaw = await MoneyConverterCall.call();
    });
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: MoneyConverterCall.call(),
      builder: (context, snapshot) {
        ...
        final converterMoneyConverterResponse = snapshot.data!;
                                  ...
                                  children: [
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText: valueOrDefault<String>(
                                          MoneyConverterCall.usd(
                                            converterMoneyConverterResponse
                                                .jsonBody,
                                          )?.toString(),
                                          'amount',
                                        ),
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (!(_model.apiResultdfq?.succeeded ??
                                            true)) {
                                          ScaffoldMessenger.of(context)
                                              .showSnackBar(
                                            SnackBar(
